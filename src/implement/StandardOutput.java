...
/**
 * Class used to print all json nodes in the result file
 */
public class StandardOutput {
    ...
    public void newOutputObject(final String error, final UserMovies currentMoviesList,
        ...
        if (currentMoviesList != null) {
            printMovies(currentMoviesList.getUserMovies(), objectMapper, currentMoviesListOut);
            outputNode.put("currentMoviesList", currentMoviesListOut);
        }
        if (currentUser != null) {
